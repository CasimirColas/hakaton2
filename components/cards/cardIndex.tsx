    ...
    <Box sx={{ height: "100vh", width: "100vw" }}>
      <Typography variant="h1" sx={{p: "3rem 0 1rem 1.5rem",
          ...
          <Box sx={{display: 'flex', justifyContent: 'center', paddingRight: '2%'}}>
            <Button onClick={() => router.push('/login')} color="secondary" variant="contained" sx={{color:"black"}} >
              <AccountBoxIcon fontSize="large"/>Connexion
            </Button>
            <Button onClick={() => router.push('/signup')} color="secondary" variant="outlined" sx={{color: "black"}}>
