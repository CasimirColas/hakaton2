    ...
    <Card sx={{ maxWidth: 345, minWidth: 340 }}>
      ...
      <Box sx={{display: "flex", justifyContent: "space-between"}}>
        <Box sx={{dispaly: "flex"}}>
            ...
            <Typography color="secondary">{realEnergy(car.energy)}</Typography>
            </Box>
      <Button variant="contained" color="secondary" sx={{backgroundColor: '#f76619', color: "black"}}>{car.cost} |  Location</Button>
      </Box>
      { matches ?
      <Accordion>
        <AccordionSummary
        ...
        <AccordionDetails>
          <Typography>
            {car.gearbox}{car.energy} Sale By {car.companyName}
